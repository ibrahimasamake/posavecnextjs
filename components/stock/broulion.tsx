    ...
    <form className="relative h-full overflow-auto flex gap-2  ">
      ...
      <div className="sticky top-0 overflow-hidden flex-1 flex flex-col gap-2 mr-4">
        <div className="text-xl font-semibold flex justify-end space-x-3   mt-2">
          <div className="text-sm border-1 border-black/10  text-black/50 px-4 py-2 rounded-full">
            Sauvegarder
          </div>
          <div className="text-sm  bg-success-400  text-black/50 px-4 py-2 rounded-full">
            Ajoute le produit
          </div>
        </div>
